...
- constrained organism families: la wildlife actual se agrupa en lagomorph / cervid / suiform / caprine / canid / mustelid / felid. Cada fine individual mantiene un family genome con founder determinista e inheritance/mutation acotados para material palette, preferencias dentro de plant niches ya legales y el trade-off stride/endurance de velocidad frente a energía. El genome no puede habilitar un plant axis que sea cero para la especie, cambiar el prey graph, trophic role ni la ecología coarse. Jev solo lo recibe como contexto read-only. Fine state, transfers y lineage lo persisten, y God View/evolution API muestran provenance coverage, medias, varianza, tendencias por generación y breeder differential.
- reusable generated organism archetypes: un species profile puede componerse a partir de módulos simulation-owned de habitat, ecology/trophic niche, procedural body y life-history. Lynx/lince es la primera validación end-to-end: combina habitat templado de bosque/colinas, ecology de depredador de emboscada mediano, body felid mediano y life-history de depredador solitario; el species registry común lo integra automáticamente en coarse ecology, competition/disease/predation, fine materialization, predator graph, family genome, lineage/evolution y God View, sin una rama de simulación específica para lynx ni nuevos assets de terceros.
