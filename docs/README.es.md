...
- multi-factor interaction selection evidence: se construyen modelos complete-case separados para reproduction / offspring / lifespan y se combinan hasta 6 presiones fuente predator / competition / disease con suficiente coverage y varianza mediante ridge estandarizado (λ=0.25). Los legacy unknown no se imputan como cero; evidencia insuficiente queda no estimable. God View muestra β*, coverage, R² y max|rX| como asociaciones regularizadas, no como efectos causales.
