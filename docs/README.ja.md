...
- 決定論的な疾病伝播。同種接触、種間 spillover、環境 reservoir、湿地/降雨/密度から disease pressure を計算します。移動は disease load を運び、fine 個体は距離加重接触と固定 spillover 係数で曝露し、God View と lineage lifetime exposure に記録されます。
