...
- reusable generated organism archetypes。species profile は habitat、ecology/trophic niche、procedural body/family、movement mode、semantic wildlife capabilities、life-history の 6 種類の simulation-owned module から構成されます。オオヤマネコは felid predator、バイソンは open-plains large-grazer / bovid、アライグマは forest-wetland opportunistic omnivore / procyonid の経路を検証します。共通 registry が coarse ecology、fine materialization、movement speed/energy、合法 action、predator graph、family genome、lineage/evolution、God View へ自動接続し、family ownership も species profile が単一 source になります。ear tufts / face mask / ringed tail は reusable procedural morphology で、新しい第三者 asset はありません。
