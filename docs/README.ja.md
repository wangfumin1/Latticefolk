...
- fitness-by-habitat エビデンス。生涯の competition、seasonal suitability、disease pressure と繁殖・子孫数・寿命の相関を測定し、低/中/高曝露 cohort ごとの breeder rate と trait differential を God View に表示します。因果とは断定しません。
