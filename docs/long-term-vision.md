...
The next organism step is **cross-domain archetype reuse**: extend the same bounded module model to monsters and domesticated forms, then connect movement modes to reusable animation/controller execution hooks. Physics, damage, resources, ownership, domestication state and population accounting remain deterministic authority.
