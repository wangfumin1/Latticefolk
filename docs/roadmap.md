...
- ⏭ Heritable organism phenotype: move selected morphology/behavior parameters from fixed species profiles into bounded inheritable genes/phenotypes with deterministic inheritance/mutation and lineage-level phenotype observability before expanding into much larger generated organism families.
