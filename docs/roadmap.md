...
- ✅ Multi-factor interaction selection evidence: outcome-specific complete-case models combine up to six varying predator/competition/disease source pressures, fit standardized ridge associations for reproduction/offspring/lifespan, and expose coverage, R², predictor collinearity and explicit non-estimable states.
