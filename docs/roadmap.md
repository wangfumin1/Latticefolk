...
- ⏭ Extend archetype composition beyond baseline wildlife: add monster and domesticated-form modules, then connect movement modes to reusable animation/controller execution semantics while keeping trophic legality, physics consequences, inventory/resources and population accounting deterministic.
