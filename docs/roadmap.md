...
- ⏭ Dedicated physics / character-controller integration: replace remaining ad-hoc blocked-cell/contact resolution with a physics authority that supports character controllers, rigid bodies, triggers, slopes, wildlife collision and unloaded-chunk sleeping without moving any physical outcome into Decision Providers.
