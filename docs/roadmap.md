...
- ⏭ Expand generated organism archetypes beyond current wildlife families: generalize family templates into reusable morphology/material/locomotion/niche modules for additional animals, monsters and later domesticated forms, while keeping coarse ecology, legal capabilities, conservation and persistence authoritative.
