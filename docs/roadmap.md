...
- ⏭ Generated organism families: generalize the species profile + phenotype machinery into constrained organism genome/archetype templates with deterministic morphology/material/locomotion/niche envelopes, while keeping generated organisms semantic gameplay entities and preserving coarse↔fine conservation/persistence.
