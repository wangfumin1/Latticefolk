...
- ⏭ Phenotype→function selection: connect morphology/behavior phenotype to deterministic locomotion/energy/foraging trade-offs and measure phenotype-by-environment reproductive/survival associations without letting the Decision Provider author physiology; then expand toward larger constrained generated organism families.
