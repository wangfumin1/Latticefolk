...
- ⏭ Broaden the archetype library: add reusable modules and composed species for additional herbivore/predator/omnivore shapes, then monsters and domesticated forms; next separate animation/movement-mode and interaction-capability modules while preserving deterministic coarse ecology and persistence.
