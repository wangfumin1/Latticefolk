...
export function validateWorldPersistenceSnapshot(input:unknown):WorldPersistenceSnapshot{
  ...
  const meta=v.obj(root.meta,'$.meta');if(meta){v.num(meta.day,'$.meta.day',{min:0});v.num(meta.minuteOfDay,'$.meta.minuteOfDay',{min:0});v.str(meta.weather,'$.meta.weather');vec(v,meta.playerPosition,'$.meta.playerPosition');inventory(v,meta.playerInventory,'$.meta.playerInventory');}
