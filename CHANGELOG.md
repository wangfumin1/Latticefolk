...
- Deterministic wildlife movement controllers: movement archetypes now carry acceleration, deceleration, turn-rate and arrival-radius parameters. A pure controller ramps fine movement speed, brakes before waypoints, clamps visual heading changes and limits oversized frame deltas while actual translation remains on pathfinder-approved segments. Runtime speed/heading are transient and God View-observable; persisted position remains authoritative. Added focused controller/profile regression tests.
