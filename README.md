...
10. ✅ identity-preserving fine wildlife migration, niche competition, seasonal movement, richer disease transmission, fitness-by-habitat, goat/wolf food-web expansion, predator-pressure observability, predator/prey specialization, realized hunting/escape evidence, and predator/prey trait matching with generation trends; next: broader multi-species coevolution evidence and richer ecology, then a fuller physics layer.
