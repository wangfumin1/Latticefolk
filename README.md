...
- **Deterministic wildlife movement controllers**: movement modes now carry gait, acceleration/deceleration, turn-rate and waypoint-arrival semantics in addition to speed/energy multipliers. Fine wildlife accelerates and turns through a pure controller step, respects blocked cells before applying displacement, and exposes controller semantics in God View. Per-frame speed/heading are transient fine-runtime state; unloaded chunks continue under coarse simulation rather than persisting meaningless frame velocity.
