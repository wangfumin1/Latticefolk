...
const zh:Dict={
  ...
  'wildlife.rabbit':'兔','wildlife.deer':'鹿','wildlife.boar':'野猪','wildlife.goat':'山羊','wildlife.fox':'狐狸','wildlife.wolf':'狼','wildlife.badger':'獾','wildlife.lynx':'猞猁','wildlife.health':'健康','wildlife.hunger':'饥饿','wildlife.thirst':'口渴','wildlife.energy':'精力','wildlife.action':'行为','wildlife.age':'年龄','wildlife.disease':'疾病负荷',
...
const en:Dict={
  ...
  'wildlife.rabbit':'Rabbit','wildlife.deer':'Deer','wildlife.boar':'Boar','wildlife.goat':'Goat','wildlife.fox':'Fox','wildlife.wolf':'Wolf','wildlife.badger':'Badger','wildlife.lynx':'Lynx','wildlife.health':'Health','wildlife.hunger':'Hunger','wildlife.thirst':'Thirst','wildlife.energy':'Energy','wildlife.action':'Action','wildlife.age':'Age','wildlife.disease':'Disease load',
...
const ja:Dict={
  ...
  'wildlife.rabbit':'ウサギ','wildlife.deer':'シカ','wildlife.boar':'イノシシ','wildlife.goat':'ヤギ','wildlife.fox':'キツネ','wildlife.wolf':'オオカミ','wildlife.badger':'アナグマ','wildlife.lynx':'オオヤマネコ','wildlife.health':'健康','wildlife.hunger':'空腹','wildlife.thirst':'渇き','wildlife.energy':'体力','wildlife.action':'行動','wildlife.age':'年齢','wildlife.disease':'疾病負荷',
...
const es:Dict={
  ...
  'wildlife.rabbit':'Conejo','wildlife.deer':'Ciervo','wildlife.boar':'Jabalí','wildlife.goat':'Cabra','wildlife.fox':'Zorro','wildlife.wolf':'Lobo','wildlife.badger':'Tejón','wildlife.lynx':'Lince','wildlife.health':'Salud','wildlife.hunger':'Hambre','wildlife.thirst':'Sed','wildlife.energy':'Energía','wildlife.action':'Acción','wildlife.age':'Edad','wildlife.disease':'Carga de enfermedad',
