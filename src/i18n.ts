...
const ja:Dict={
  ...
  'evolution.title':'進化観測','evolution.tracked':'系譜 生存/履歴','evolution.births':'出生','evolution.deaths':'死亡','evolution.lifespan':'平均寿命','evolution.reproduction':'繁殖成功率','evolution.lineage':'祖先系譜','evolution.noAncestors':'記録済み祖先なし','evolution.topLineages':'繁殖上位系譜','evolution.empty':'追跡済み系譜はまだありません','evolution.mortality':'死亡原因','evolution.predation':'捕食','evolution.disease':'疾病','evolution.starvation':'飢餓','evolution.dehydration':'脱水','evolution.senescence':'老衰','evolution.habitat':'環境','evolution.signal.insufficient':'データ不足','evolution.signal.weak':'弱い選択シグナル','evolution.signal.persistent':'持続的な選択シグナル','evolution.origin':'出生環境','evolution.lifetime':'生涯環境','evolution.exposure':'観測曝露','evolution.dominantBiome':'主要 biome','evolution.transitions':'観測移動',
