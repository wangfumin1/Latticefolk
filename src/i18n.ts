...
const zh:Dict={
  ...
  'item.grain':'谷物','item.water':'水','item.stone':'石料','item.tool':'工具',
  'weather.clear':'晴','weather.cloudy':'多云','weather.rain':'雨',
  'prompt.talk':'[E] 与 {name} 交谈','prompt.object':'[E] {name} · {count} 项交互',
...
const en:Dict={
  ...
  'item.grain':'Grain','item.water':'Water','item.stone':'Stone','item.tool':'Tool',
  'weather.clear':'Clear','weather.cloudy':'Cloudy','weather.rain':'Rain',
  'prompt.talk':'[E] Talk to {name}','prompt.object':'[E] {name} · {count} actions',
...
const ja:Dict={
  ...
  'item.grain':'穀物','item.water':'水','item.stone':'石材','item.tool':'道具',
  'weather.clear':'晴れ','weather.cloudy':'曇り','weather.rain':'雨',
  'prompt.talk':'[E] {name} と話す','prompt.object':'[E] {name} · {count} 操作',
...
const es:Dict={
  ...
  'item.grain':'Grano','item.water':'Agua','item.stone':'Piedra','item.tool':'Herramienta',
  'weather.clear':'Despejado','weather.cloudy':'Nublado','weather.rain':'Lluvia',
  'prompt.talk':'[E] Hablar con {name}','prompt.object':'[E] {name} · {count} acciones',
