...
const zh:Dict={
  ...
  'evolution.title':'进化观测','evolution.tracked':'谱系存活/历史','evolution.births':'出生','evolution.deaths':'死亡','evolution.lifespan':'平均寿命','evolution.reproduction':'繁殖成功率','evolution.lineage':'祖先谱系','evolution.noAncestors':'暂无已记录祖先','evolution.topLineages':'高繁殖谱系','evolution.empty':'尚无可统计的个体谱系',
...
const ja:Dict={
  ...
  'evolution.title':'進化観測','evolution.tracked':'系譜 生存/履歴','evolution.births':'出生','evolution.deaths':'死亡','evolution.lifespan':'平均寿命','evolution.reproduction':'繁殖成功率','evolution.lineage':'祖先系譜','evolution.noAncestors':'記録済み祖先なし','evolution.topLineages':'繁殖上位系譜','evolution.empty':'追跡済み系譜はまだありません',
...
const es:Dict={
  ...
  'evolution.title':'Observatorio evolutivo','evolution.tracked':'linaje vivos/históricos','evolution.births':'nacimientos','evolution.deaths':'muertes','evolution.lifespan':'vida media','evolution.reproduction':'éxito reproductivo','evolution.lineage':'ascendencia','evolution.noAncestors':'sin ancestros registrados','evolution.topLineages':'linajes más reproductivos','evolution.empty':'aún no hay linajes individuales registrados',
