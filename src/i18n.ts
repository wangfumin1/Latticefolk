...
const zh:Dict={
  ...
  'wildlife.rabbit':'兔','wildlife.deer':'鹿','wildlife.boar':'野猪','wildlife.fox':'狐狸','wildlife.health':'健康','wildlife.hunger':'饥饿','wildlife.thirst':'口渴','wildlife.energy':'精力','wildlife.action':'行为','wildlife.age':'年龄',
...
const en:Dict={
  ...
  'wildlife.rabbit':'Rabbit','wildlife.deer':'Deer','wildlife.boar':'Boar','wildlife.fox':'Fox','wildlife.health':'Health','wildlife.hunger':'Hunger','wildlife.thirst':'Thirst','wildlife.energy':'Energy','wildlife.action':'Action','wildlife.age':'Age',
...
const ja:Dict={
  ...
  'wildlife.rabbit':'ウサギ','wildlife.deer':'シカ','wildlife.boar':'イノシシ','wildlife.fox':'キツネ','wildlife.health':'健康','wildlife.hunger':'空腹','wildlife.thirst':'渇き','wildlife.energy':'体力','wildlife.action':'行動','wildlife.age':'年齢',
...
const es:Dict={
  ...
  'wildlife.rabbit':'Conejo','wildlife.deer':'Ciervo','wildlife.boar':'Jabalí','wildlife.fox':'Zorro','wildlife.health':'Salud','wildlife.hunger':'Hambre','wildlife.thirst':'Sed','wildlife.energy':'Energía','wildlife.action':'Acción','wildlife.age':'Edad',
