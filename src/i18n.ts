...
const zh:Dict={
  ...
  'prompt.talk':'[E] 与 {name} 交谈','prompt.object':'[E] {name} · {count} 项交互','prompt.wildlife':'[E] 观察 / 互动 {name}',
  'wildlife.rabbit':'兔','wildlife.deer':'鹿','wildlife.boar':'野猪','wildlife.goat':'山羊','wildlife.fox':'狐狸','wildlife.wolf':'狼','wildlife.badger':'獾','wildlife.lynx':'猞猁','wildlife.bison':'野牛','wildlife.raccoon':'浣熊','wildlife.sheep':'绵羊','wildlife.warg':'座狼','wildlife.health':'健康','wildlife.hunger':'饥饿','wildlife.thirst':'口渴','wildlife.energy':'精力','wildlife.action':'行为','wildlife.age':'年龄','wildlife.disease':'疾病负荷',
  'wildlife.domestication.action.inspect':'查看','wildlife.domestication.action.feed_tame':'喂食驯化','wildlife.domestication.action.command_follow':'命令：跟随','wildlife.domestication.action.command_stay':'命令：待命','wildlife.domestication.action.command_forage':'命令：觅食','wildlife.domestication.action.release':'解除归属',
  'wildlife.domestication.stage.feral':'未驯化','wildlife.domestication.stage.taming':'驯化中','wildlife.domestication.stage.bonded':'已建立归属','wildlife.domestication.command.autonomous':'自主','wildlife.domestication.command.follow':'跟随','wildlife.domestication.command.stay':'待命','wildlife.domestication.command.forage':'觅食','wildlife.domestication.meta':'{stage} · 进度 {progress}% · 命令 {command}','wildlife.domestication.notEligible':'该物种不进入个体驯化体系','wildlife.domestication.needFood':'需要谷物或苹果才能继续驯化','wildlife.domestication.aggregateBlocked':'该实体仍代表多个 coarse 个体，不能作为单只动物驯化','wildlife.domestication.individualizeFailed':'无法在不破坏数量守恒的前提下拆分该个体','wildlife.domestication.bonded':'{name} 已与玩家建立归属','wildlife.domestication.progress':'驯化进度 {progress}%','wildlife.domestication.released':'已解除 {name} 的玩家归属','wildlife.domestication.commandSet':'已设置命令：{command}',
...
const en:Dict={
  ...
  'prompt.talk':'[E] Talk to {name}','prompt.object':'[E] {name} · {count} actions','prompt.wildlife':'[E] Observe / interact with {name}',
  'wildlife.rabbit':'Rabbit','wildlife.deer':'Deer','wildlife.boar':'Boar','wildlife.goat':'Goat','wildlife.fox':'Fox','wildlife.wolf':'Wolf','wildlife.badger':'Badger','wildlife.lynx':'Lynx','wildlife.bison':'Bison','wildlife.raccoon':'Raccoon','wildlife.sheep':'Sheep','wildlife.warg':'Warg','wildlife.health':'Health','wildlife.hunger':'Hunger','wildlife.thirst':'Thirst','wildlife.energy':'Energy','wildlife.action':'Action','wildlife.age':'Age','wildlife.disease':'Disease load',
  'wildlife.domestication.action.inspect':'Inspect','wildlife.domestication.action.feed_tame':'Feed to tame','wildlife.domestication.action.command_follow':'Command: follow','wildlife.domestication.action.command_stay':'Command: stay','wildlife.domestication.action.command_forage':'Command: forage','wildlife.domestication.action.release':'Release ownership',
  'wildlife.domestication.stage.feral':'feral','wildlife.domestication.stage.taming':'taming','wildlife.domestication.stage.bonded':'bonded','wildlife.domestication.command.autonomous':'autonomous','wildlife.domestication.command.follow':'follow','wildlife.domestication.command.stay':'stay','wildlife.domestication.command.forage':'forage','wildlife.domestication.meta':'{stage} · progress {progress}% · command {command}','wildlife.domestication.notEligible':'This species is not eligible for individual domestication','wildlife.domestication.needFood':'Grain or an apple is required to continue taming','wildlife.domestication.aggregateBlocked':'This entity still represents multiple coarse animals and cannot be tamed as one individual','wildlife.domestication.individualizeFailed':'The individual could not be split without violating population conservation','wildlife.domestication.bonded':'{name} is now bonded to the player','wildlife.domestication.progress':'Taming progress {progress}%','wildlife.domestication.released':'Player ownership of {name} released','wildlife.domestication.commandSet':'Command set: {command}',
...
const ja:Dict={
  ...
  'prompt.talk':'[E] {name} と話す','prompt.object':'[E] {name} · {count} 操作','prompt.wildlife':'[E] {name} を観察 / 操作',
  'wildlife.rabbit':'ウサギ','wildlife.deer':'シカ','wildlife.boar':'イノシシ','wildlife.goat':'ヤギ','wildlife.fox':'キツネ','wildlife.wolf':'オオカミ','wildlife.badger':'アナグマ','wildlife.lynx':'オオヤマネコ','wildlife.bison':'バイソン','wildlife.raccoon':'アライグマ','wildlife.sheep':'ヒツジ','wildlife.warg':'ワーグ','wildlife.health':'健康','wildlife.hunger':'空腹','wildlife.thirst':'渇き','wildlife.energy':'体力','wildlife.action':'行動','wildlife.age':'年齢','wildlife.disease':'疾病負荷',
  'wildlife.domestication.action.inspect':'確認','wildlife.domestication.action.feed_tame':'餌を与えて馴らす','wildlife.domestication.action.command_follow':'命令：追従','wildlife.domestication.action.command_stay':'命令：待機','wildlife.domestication.action.command_forage':'命令：採食','wildlife.domestication.action.release':'所有を解除',
  'wildlife.domestication.stage.feral':'未馴化','wildlife.domestication.stage.taming':'馴化中','wildlife.domestication.stage.bonded':'帰属済み','wildlife.domestication.command.autonomous':'自律','wildlife.domestication.command.follow':'追従','wildlife.domestication.command.stay':'待機','wildlife.domestication.command.forage':'採食','wildlife.domestication.meta':'{stage} · 進捗 {progress}% · 命令 {command}','wildlife.domestication.notEligible':'この種は個体馴化の対象ではありません','wildlife.domestication.needFood':'馴化を続けるには穀物かリンゴが必要です','wildlife.domestication.aggregateBlocked':'この実体は複数の coarse 個体を代表しているため、1 個体として馴化できません','wildlife.domestication.individualizeFailed':'個体数保存を壊さずに個体化できません','wildlife.domestication.bonded':'{name} がプレイヤーに帰属しました','wildlife.domestication.progress':'馴化進捗 {progress}%','wildlife.domestication.released':'{name} のプレイヤー帰属を解除しました','wildlife.domestication.commandSet':'命令を設定：{command}',
...
const es:Dict={
  ...
  'prompt.talk':'[E] Hablar con {name}','prompt.object':'[E] {name} · {count} acciones','prompt.wildlife':'[E] Observar / interactuar con {name}',
  'wildlife.rabbit':'Conejo','wildlife.deer':'Ciervo','wildlife.boar':'Jabalí','wildlife.goat':'Cabra','wildlife.fox':'Zorro','wildlife.wolf':'Lobo','wildlife.badger':'Tejón','wildlife.lynx':'Lince','wildlife.bison':'Bisonte','wildlife.raccoon':'Mapache','wildlife.sheep':'Oveja','wildlife.warg':'Warg','wildlife.health':'Salud','wildlife.hunger':'Hambre','wildlife.thirst':'Sed','wildlife.energy':'Energía','wildlife.action':'Acción','wildlife.age':'Edad','wildlife.disease':'Carga de enfermedad',
  'wildlife.domestication.action.inspect':'Inspeccionar','wildlife.domestication.action.feed_tame':'Alimentar para domesticar','wildlife.domestication.action.command_follow':'Orden: seguir','wildlife.domestication.action.command_stay':'Orden: quedarse','wildlife.domestication.action.command_forage':'Orden: alimentarse','wildlife.domestication.action.release':'Liberar propiedad',
  'wildlife.domestication.stage.feral':'salvaje','wildlife.domestication.stage.taming':'domesticando','wildlife.domestication.stage.bonded':'vinculado','wildlife.domestication.command.autonomous':'autónomo','wildlife.domestication.command.follow':'seguir','wildlife.domestication.command.stay':'quedarse','wildlife.domestication.command.forage':'alimentarse','wildlife.domestication.meta':'{stage} · progreso {progress}% · orden {command}','wildlife.domestication.notEligible':'Esta especie no admite domesticación individual','wildlife.domestication.needFood':'Se necesita grano o una manzana para continuar la domesticación','wildlife.domestication.aggregateBlocked':'Esta entidad aún representa varios animales coarse y no puede domesticarse como un solo individuo','wildlife.domestication.individualizeFailed':'No se pudo separar el individuo sin romper la conservación de población','wildlife.domestication.bonded':'{name} ahora está vinculado al jugador','wildlife.domestication.progress':'Progreso de domesticación {progress}%','wildlife.domestication.released':'Se liberó la propiedad del jugador sobre {name}','wildlife.domestication.commandSet':'Orden establecida: {command}',
