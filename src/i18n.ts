...
const zh:Dict={
  ...
  'prompt.talk':'[E] 与 {name} 交谈','prompt.object':'[E] {name} · {count} 项交互','prompt.wildlife':'[E] 观察 {name}','prompt.domesticated':'[E] 管理 {name}',
    'domestication.title':'驯养管理','domestication.ineligible':'该物种不支持个体驯养','domestication.feed':'喂食并驯化（消耗 1 谷物）','domestication.needGrain':'需要 1 份谷物','domestication.claimed':'已建立玩家所有权','domestication.progress':'驯化进度','domestication.owner':'所有者','domestication.unowned':'未归属','domestication.command':'命令','domestication.command.none':'自主行动','domestication.command.follow':'跟随','domestication.command.stay':'原地停留','domestication.command.feed':'自主进食','domestication.breeding':'繁殖许可','domestication.breeding.on':'允许繁殖','domestication.breeding.off':'禁止繁殖','domestication.enableBreeding':'允许繁殖','domestication.disableBreeding':'暂停繁殖',
...
const en:Dict={
  ...
  'prompt.talk':'[E] Talk to {name}','prompt.object':'[E] {name} · {count} actions','prompt.wildlife':'[E] Observe {name}','prompt.domesticated':'[E] Manage {name}',
    'domestication.title':'Domestication','domestication.ineligible':'This species has no individual domestication capability','domestication.feed':'Feed & tame (uses 1 grain)','domestication.needGrain':'Requires 1 grain','domestication.claimed':'Player ownership established','domestication.progress':'Taming progress','domestication.owner':'Owner','domestication.unowned':'Unowned','domestication.command':'Command','domestication.command.none':'Autonomous','domestication.command.follow':'Follow','domestication.command.stay':'Stay','domestication.command.feed':'Self-feed','domestication.breeding':'Breeding permission','domestication.breeding.on':'Allowed','domestication.breeding.off':'Blocked','domestication.enableBreeding':'Allow breeding','domestication.disableBreeding':'Pause breeding',
