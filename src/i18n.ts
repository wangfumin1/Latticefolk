...
const zh:Dict={
  ...
  'interaction.pickup':'拾取','interaction.open_door':'开门','interaction.close_door':'关门','interaction.visit':'拜访','door.opened':'{name}：门已打开','door.closed':'{name}：门已关闭','door.blocked':'{name}：门口有实体，无法关门',
  ...
  'prompt.talk':'[E] 与 {name} 交谈','prompt.object':'[E] {name} · {count} 项交互','prompt.wildlife':'[E] 观察 {name}','prompt.domesticated':'[E] 管理 {name}',
    'domestication.title':'驯养管理','domestication.ineligible':'该物种不支持个体驯养','domestication.feed':'喂食并驯化（消耗 1 谷物）','domestication.needGrain':'需要 1 份谷物','domestication.claimed':'已建立玩家所有权','domestication.progress':'驯化进度','domestication.owner':'所有者','domestication.unowned':'未归属','domestication.command':'命令','domestication.command.none':'自主行动','domestication.command.follow':'跟随','domestication.command.stay':'原地停留','domestication.command.graze':'自主进食','domestication.breeding':'繁殖许可','domestication.breeding.on':'允许繁殖','domestication.breeding.off':'禁止繁殖','domestication.enableBreeding':'允许繁殖','domestication.disableBreeding':'暂停繁殖',
...
const en:Dict={
  ...
  'interaction.pickup':'Pick up','interaction.open_door':'Open door','interaction.close_door':'Close door','interaction.visit':'Visit','door.opened':'{name}: door opened','door.closed':'{name}: door closed','door.blocked':'{name}: doorway occupied; cannot close',
  ...
  'prompt.talk':'[E] Talk to {name}','prompt.object':'[E] {name} · {count} actions','prompt.wildlife':'[E] Observe {name}','prompt.domesticated':'[E] Manage {name}',
    'domestication.title':'Domestication','domestication.ineligible':'This species has no individual domestication capability','domestication.feed':'Feed & tame (uses 1 grain)','domestication.needGrain':'Requires 1 grain','domestication.claimed':'Player ownership established','domestication.progress':'Taming progress','domestication.owner':'Owner','domestication.unowned':'Unowned','domestication.command':'Command','domestication.command.none':'Autonomous','domestication.command.follow':'Follow','domestication.command.stay':'Stay','domestication.command.graze':'Self-feed','domestication.breeding':'Breeding permission','domestication.breeding.on':'Allowed','domestication.breeding.off':'Blocked','domestication.enableBreeding':'Allow breeding','domestication.disableBreeding':'Pause breeding',
...
const ja:Dict={
  ...
  'interaction.pickup':'拾う','interaction.open_door':'ドアを開ける','interaction.close_door':'ドアを閉める','interaction.visit':'訪問','door.opened':'{name}：ドアを開けました','door.closed':'{name}：ドアを閉めました','door.blocked':'{name}：入口に実体がいるため閉められません',
  ...
  'prompt.talk':'[E] {name} と話す','prompt.object':'[E] {name} · {count} 操作','prompt.wildlife':'[E] {name} を観察','prompt.domesticated':'[E] {name} を管理',
    'domestication.title':'家畜管理','domestication.ineligible':'この種は個体の家畜化に対応していません','domestication.feed':'餌を与えて慣らす（穀物 1 消費）','domestication.needGrain':'穀物が 1 必要です','domestication.claimed':'プレイヤー所有になりました','domestication.progress':'慣らし進捗','domestication.owner':'所有者','domestication.unowned':'未所有','domestication.command':'命令','domestication.command.none':'自律行動','domestication.command.follow':'追従','domestication.command.stay':'待機','domestication.command.graze':'自力採食','domestication.breeding':'繁殖許可','domestication.breeding.on':'許可','domestication.breeding.off':'禁止','domestication.enableBreeding':'繁殖を許可','domestication.disableBreeding':'繁殖を停止',
...
const es:Dict={
  ...
  'interaction.pickup':'Recoger','interaction.open_door':'Abrir puerta','interaction.close_door':'Cerrar puerta','interaction.visit':'Visitar','door.opened':'{name}: puerta abierta','door.closed':'{name}: puerta cerrada','door.blocked':'{name}: la entrada está ocupada; no se puede cerrar',
  ...
  'prompt.talk':'[E] Hablar con {name}','prompt.object':'[E] {name} · {count} acciones','prompt.wildlife':'[E] Observar {name}','prompt.domesticated':'[E] Gestionar {name}',
    'domestication.title':'Domesticación','domestication.ineligible':'Esta especie no admite domesticación individual','domestication.feed':'Alimentar y domesticar (consume 1 grano)','domestication.needGrain':'Se necesita 1 grano','domestication.claimed':'Propiedad del jugador establecida','domestication.progress':'Progreso de domesticación','domestication.owner':'Propietario','domestication.unowned':'Sin propietario','domestication.command':'Orden','domestication.command.none':'Autónomo','domestication.command.follow':'Seguir','domestication.command.stay':'Quedarse','domestication.command.graze':'Alimentarse','domestication.breeding':'Permiso de cría','domestication.breeding.on':'Permitida','domestication.breeding.off':'Bloqueada','domestication.enableBreeding':'Permitir cría','domestication.disableBreeding':'Pausar cría',
