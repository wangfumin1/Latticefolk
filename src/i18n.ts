...
const zh:Dict={
  ...
  'wildlife.domestication.action.inspect':'查看','wildlife.domestication.action.feed_tame':'喂食驯化','wildlife.domestication.action.command_follow':'命令：跟随','wildlife.domestication.action.command_stay':'命令：待命','wildlife.domestication.action.command_graze':'命令：觅食','wildlife.domestication.action.release':'解除归属',
  'wildlife.domestication.stage.feral':'未驯化','wildlife.domestication.stage.taming':'驯化中','wildlife.domestication.stage.bonded':'已建立归属','wildlife.domestication.command.autonomous':'自主','wildlife.domestication.command.follow':'跟随','wildlife.domestication.command.stay':'待命','wildlife.domestication.command.graze':'觅食','wildlife.domestication.meta':'{stage} · 进度 {progress}% · 命令 {command}','wildlife.domestication.notEligible':'该物种不进入个体驯化体系','wildlife.domestication.needFood':'需要谷物或苹果才能继续驯化','wildlife.domestication.aggregateBlocked':'该实体仍代表多个 coarse 个体，不能作为单只动物驯化','wildlife.domestication.individualizeFailed':'无法在不破坏数量守恒的前提下拆分该个体','wildlife.domestication.bonded':'{name} 已与玩家建立归属','wildlife.domestication.progress':'驯化进度 {progress}%','wildlife.domestication.released':'已解除 {name} 的玩家归属','wildlife.domestication.commandSet':'已设置命令：{command}',
...
const ja:Dict={
  ...
  'wildlife.domestication.action.inspect':'確認','wildlife.domestication.action.feed_tame':'餌を与えて馴らす','wildlife.domestication.action.command_follow':'命令：追従','wildlife.domestication.action.command_stay':'命令：待機','wildlife.domestication.action.command_graze':'命令：採食','wildlife.domestication.action.release':'所有を解除',
  'wildlife.domestication.stage.feral':'未馴化','wildlife.domestication.stage.taming':'馴化中','wildlife.domestication.stage.bonded':'帰属済み','wildlife.domestication.command.autonomous':'自律','wildlife.domestication.command.follow':'追従','wildlife.domestication.command.stay':'待機','wildlife.domestication.command.graze':'採食','wildlife.domestication.meta':'{stage} · 進捗 {progress}% · 命令 {command}','wildlife.domestication.notEligible':'この種は個体馴化の対象ではありません','wildlife.domestication.needFood':'馴化を続けるには穀物かリンゴが必要です','wildlife.domestication.aggregateBlocked':'この実体は複数の coarse 個体を代表しているため、1 個体として馴化できません','wildlife.domestication.individualizeFailed':'個体数保存を壊さずに個体化できません','wildlife.domestication.bonded':'{name} がプレイヤーに帰属しました','wildlife.domestication.progress':'馴化進捗 {progress}%','wildlife.domestication.released':'{name} のプレイヤー帰属を解除しました','wildlife.domestication.commandSet':'命令を設定：{command}',
