...
const zh:Dict={
  ...
  'evolution.title':'进化观测','evolution.tracked':'谱系存活/历史','evolution.births':'出生','evolution.deaths':'死亡','evolution.lifespan':'平均寿命','evolution.reproduction':'繁殖成功率','evolution.lineage':'祖先谱系','evolution.noAncestors':'暂无已记录祖先','evolution.topLineages':'高繁殖谱系','evolution.empty':'尚无可统计的个体谱系','evolution.mortality':'死亡原因','evolution.predation':'捕食','evolution.disease':'疾病','evolution.starvation':'饥饿','evolution.dehydration':'脱水','evolution.senescence':'衰老',
...
const ja:Dict={
  ...
  'evolution.title':'進化観測','evolution.tracked':'系譜 生存/履歴','evolution.births':'出生','evolution.deaths':'死亡','evolution.lifespan':'平均寿命','evolution.reproduction':'繁殖成功率','evolution.lineage':'祖先系譜','evolution.noAncestors':'記録済み祖先なし','evolution.topLineages':'繁殖上位系譜','evolution.empty':'追跡済み系譜はまだありません','evolution.mortality':'死亡原因','evolution.predation':'捕食','evolution.disease':'疾病','evolution.starvation':'飢餓','evolution.dehydration':'脱水','evolution.senescence':'老衰',
