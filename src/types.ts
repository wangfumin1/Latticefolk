...
export type WildlifeSpecies = 'rabbit' | 'deer' | 'boar' | 'goat' | 'fox' | 'wolf' | 'badger' | 'lynx' | 'bison' | 'raccoon' | 'sheep' | 'warg';
...
export type WildlifeOrganismFamily='lagomorph'|'cervid'|'suiform'|'caprine'|'canid'|'mustelid'|'felid'|'bovid'|'procyonid';
